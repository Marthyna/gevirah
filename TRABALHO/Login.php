                ...
                <tr>
                    <td colspan=3 width="100%" height="590">
                        ...
                        <tr>
                            ...
                            <?php                                
                                if (isset ($_POST['logar'])){  // Se o botão Entrar foi clicado, será impressa uma mensagem de confirmação de login e um link de volta à página inicial
                                    echo 
                                    "<div align='center'>
                                        <h1>
                                            <font face='Assistant' color=#2B3253>Você está logado, ",$_POST['nome'],"!
                                            </font>
                                        </h1>                                                                       
                                        <div align=center><button class='button'><a href='Home.html'>Voltar à Página Inicial</a></button></div>
                                    </div> 
                                    "; /*Foi usada a classe button para modificar a aparência do botão com  CSS*/
                                }
                            ?>
                            </td>
                        </tr>                        
